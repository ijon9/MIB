...
command = "CREATE TABLE IF NOT EXISTS calendar(creator TEXT, name TEXT, day TEXT, clock TEXT, location TEXT, description TEXT, public INTEGER, alert TEXT, priority INTEGER)"
c.execute(command)
