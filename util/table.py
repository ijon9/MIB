...
command = "CREATE TABLE IF NOT EXISTS calendar(creator TEXT, name TEXT, time TEXT, frequency TEXT, location TEXT, description TEXT, public INTEGER, alert TEXT, priority INTEGER)"
c.execute(command)
